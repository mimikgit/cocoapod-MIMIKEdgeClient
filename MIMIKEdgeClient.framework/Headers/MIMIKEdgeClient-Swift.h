...
SWIFT_CLASS("_TtC15MIMIKEdgeClient23MIMIKCredentialsManager")
@interface MIMIKCredentialsManager : NSObject
...
SWIFT_CLASS("_TtC15MIMIKEdgeClient19MIMIKLicenseManager")
@interface MIMIKLicenseManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15MIMIKEdgeClient16MIMIKPortManager")
@interface MIMIKPortManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15MIMIKEdgeClient29MIMIKStartupParametersManager")
@interface MIMIKStartupParametersManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
